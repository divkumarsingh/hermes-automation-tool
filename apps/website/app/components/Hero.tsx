...
export const Hero = () => {
    ...
    return(
        <div className=" container flex flex-col my-4 py-20 px-8 items-center gap-4">
            ...
            <div className="contianer flex flex-row items-center justify-baseline px-8 py-8  gap-8 ">
